...
def draw(field_img):
    ...
    centre_marker_coord = [
        (
            centre[0] - 2 * field_px["field_line_width"],
    ...
    centre_circle_coord = [
        (
            centre[0] - field_px["centre_circle_radius"],
            centre[1] - field_px["centre_circle_radius"],
        ),
        (
            centre[0] + field_px["centre_circle_radius"],
            centre[1] + field_px["centre_circle_radius"],
    ...
    centre_line_coord = [
        (centre[0] - field_px["field_line_width"], centre[1] - field_px["width"] / 2.0),
        (centre[0] + field_px["field_line_width"], centre[1] + field_px["width"] / 2.0),
    ]
    ...
    l_pen_coord_horz = [
        (
            centre[0]
            - field_px["length"] / 2.0
            + field_px["penalty_mark_dist"]
            - 2 * field_px["field_line_width"],
            centre[1] - field_px["field_line_width"],
        ),
        (
            centre[0]
    ...
    r_pen_coord_horz = [
        (x + field_px["length"] - 2 * field_px["penalty_mark_dist"], y)
        for (x, y) in l_pen_coord_horz
    ]
    # Vertical
    l_pen_coord_vert = [
        (
    ...
    r_pen_coord_vert = [
        (x + field_px["length"] - 2 * field_px["penalty_mark_dist"], y)
        for (x, y) in l_pen_coord_vert
    ]

    # Calculate border coordinates for top left and bottom right corners
    border_coord = [
        (centre[0] - field_px["length"] / 2.0, centre[1] - field_px["width"] / 2.0),
        (centre[0] + field_px["length"] / 2.0, centre[1] + field_px["width"] / 2.0),
    ]
    ...
    l_goal_box_coord = [
        (
            centre[0] - field_px["length"] / 2.0,
            centre[1] - field_px["goal_area"]["width"] / 2.0,
        ),
        (
            centre[0] - field_px["length"] / 2.0 + field_px["goal_area"]["length"],
            centre[1] + field_px["goal_area"]["width"] / 2.0,
        ),
    ]
    r_goal_box_coord = [
        (x + field_px["length"] - field_px["goal_area"]["length"], y)
        for (x, y) in l_goal_box_coord
    ]
    ...
    l_goal_int_coord = [
        (
            centre[0] - field_px["length"] / 2.0 - goal_px["depth"],
            centre[1] - goal_px["width"] / 2.0,
        ),
        (centre[0] - field_px["length"] / 2.0, centre[1] + goal_px["width"] / 2.0),
    ]
    r_goal_int_coord = [
        (x + field_px["length"] + goal_px["depth"], y) for (x, y) in l_goal_int_coord
    ]
    ...
    draw_shape(
        ...
        centre_circle_coord,
        shape="ellipse",
        width=field_px["field_line_width"],
    )
    ...
    for rect in [
        ...
        draw_shape(
            field_img, rect, shape="rectangle", width=field_px["field_line_width"]
        )
